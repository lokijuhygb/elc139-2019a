...
Comparativo entre OpenMP e TBB (Threading Building Blocks) utilizando #pragma simd e o problema Mandelbrot no node [CDER03](https://help.rs.gsu.edu/display/PD/CDER).
